...
1. Download [`eiko_matlab.zip`](https://github.com/sebftw/Eiko/releases/download/v0.8.5/eiko_matlab.zip) from the latest Eiko release, and extract the "eiko" folder.
