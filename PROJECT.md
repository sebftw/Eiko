...
* **Multiplicative factorization techniques:** Factorization techniques improve the accuracy of the calculation (especially at discontinuities), but they inherently require a known closed-form estimate of the time-of-flight, making them applicable in only certain cases (e.g., a point source). If higher accuracy is desired, one can instead increase the grid density.
