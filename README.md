...
```
Requires MATLAB R2018b+ with the Parallel Computing Toolbox. See the [MATLAB installation guide](/matlab/MATLAB_INSTALLATION.md) for more details and options.
<!-- END_MATLAB_ONLY -->
